...
def mhalo2mstar_behroozi13_lowmass_powerlaw(log_mhalo):
    # only for lower mass end
    Mhalo = 10**log_mhalo
...
def mhalo2mstar_gk17(log_mhalo, scatter=0.2, do_print=False):
    ...
    alpha_LF = 0.24*scatter**2 + 0.16*scatter + 1.99
    ...
    if do_print == True:
        print(">> Note that GK14 derivation is for logM*=6-8, Kroupa IMF in FIRE\n")
